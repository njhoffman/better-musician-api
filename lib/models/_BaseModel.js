...
class BaseModel {
  ...
  static get seedData () {
    ...
    if (existsSync(envPath)) {
      ...
      return require(envPath).default;
  ...
  static seed (num = 0, mergeObj) {
    ...
    info(`Seeding records for table: ${this.tableName}, model: ${this.modelName} with ${Object.keys(exampleData).length} keys`);
    return this.db
      .table(this.tableName)
      .insert(exampleData)
      .run(this.conn)
